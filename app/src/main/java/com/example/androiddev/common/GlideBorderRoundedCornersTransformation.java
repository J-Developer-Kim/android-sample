...
public class GlideBorderRoundedCornersTransformation implements Transformation<Bitmap> {
    ...
    public GlideBorderRoundedCornersTransformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public GlideBorderRoundedCornersTransformation(Context context, int radius, int margin, String color, int border) {
        this(context, radius, margin, CornerType.BORDER);
        mColor = color;
        mBorder = border;
    }

    public GlideBorderRoundedCornersTransformation(BitmapPool pool, int radius, int margin) {
